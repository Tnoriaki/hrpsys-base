...
namespace rats
{
  ...
  public:
    ...
    gait_generator (double _dt,
        ...
        vel_param(), offset_vel_param(), thtc(), cog(hrp::Vector3::Zero()), refzmp(hrp::Vector3::Zero()), prev_que_rzmp(hrp::Vector3::Zero()), vrp(hrp::Vector3::Zero()), diff_cp(hrp::Vector3::Zero()), modified_d_footstep(hrp::Vector3::Zero()),
        ...
        use_inside_step_limitation(true), use_stride_limitation(false), modify_footsteps(false), is_first_count(false), default_stride_limitation_type(SQUARE),
